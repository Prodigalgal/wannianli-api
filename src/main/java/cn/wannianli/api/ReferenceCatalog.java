...
public final class ReferenceCatalog {
    ...
    public static List<Reference> all() {
        return List.of(
                ...
                reference("ZENGSHAN_BUYI_CHAPTER_26", "《增删卜易》旬空章第二十六", "清代卜筮古籍", "清代传本电子转录",
                        "六甲旬空完整表及甲子旬无戌亥之释义", "https://zh.wikisource.org/zh-hans/增删卜易/26",
                        "B_PRIMARY_TEXT_TRANSCRIPTION", "六旬所属旬与旬空两支的直接规则依据",
                        "书中旺衰、动静、填实等内容属于六爻占断，不并入本API的日级宜忌。"),
                reference("GUJIN_TUSHU_JICHENG_VOLUME_592", "《钦定古今图书集成》卷五百九十二", "清代敕修类书", "1700-1725年成书影印页",
                        "术数部·六甲孤虚法", "https://zh.wikisource.org/wiki/Page:Gujin_Tushu_Jicheng,_Volume_592_(1700-1725).djvu/114",
                        "B_PRIMARY_SCAN", "甲子旬无戌亥至甲寅旬无子丑的六组缺支交叉校验",
                        "原文使用孤虚术语；本API只取每旬未覆盖两支作为旬空，不扩展计算相对的虚方。"),
