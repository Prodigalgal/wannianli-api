        ...
        return List.of(
                ...
                reference("HKO_2026", "2026（丙午—肖马）年公历与农历日期对照表", "政府天文机构年历", "2026",
                        "香港天文台一页年历", "https://www.hko.gov.hk/tc/gts/time/calendar/pdf/files/2026.pdf",
                         ...
                         "不提供四柱、神煞或择吉规则。"),
                reference("HKO_2026_AUGUST", "2026年8月太阳、月球出没及民用曙暮光时间", "政府天文机构月历", "2026-08",
                        "月相及二十四节气", "https://www.hko.gov.hk/tc/gts/astron2026/files/2026cal08.pdf",
                        "A_OFFICIAL_VALIDATION", "2026年大暑、立秋、处暑及七月朔的分钟级回归基准",
                        "只验证该月公开到分钟的天象时刻。"),
                reference("IMCCE_VSOP87D_EARTH", "VSOP87D Earth solution", "官方天文系数数据", "VSOP87D",
                        "VSOP87D.ear; SHA-256 8B160C859136D467F2BE7FC29EFA8A9652E95516DFBDE00E4C739D7DDC90CA91",
                        "https://ftp.imcce.fr/pub/ephem/planets/vsop87/VSOP87D.ear",
                        "A_TECHNICAL_METHOD", "太阳几何黄经与日地距离的项目内数值计算",
                        "项目生成器固定截取各阶主项；不是完整系数文件的逐项运行时加载。"),
                reference("MEEUS_ASTRONOMICAL_ALGORITHMS", "Astronomical Algorithms", "现代天文算法文献", "Jean Meeus, 2nd ed., 1998",
                        ...
                        "A_TECHNICAL_METHOD", "太阳视位置修正、节气求根与真朔时刻数值算法",
                        "真朔为周期项截断公式；未来精度还受Delta T预测影响。"),
                ...
                reference("YUXIAJI_TRADITION", "《玉匣记》通书系统", "明清民间通书古籍", "维基文库转录",
                        "彭祖百忌", "https://zh.wikisource.org/zh-hant/玉匣記",
                        "C_TRADITIONAL_TRANSMISSION", "彭祖百忌原句与附加禁忌",
                        "未证实属于《协纪辨方书》正文，优先级低于官修主规则。"),
                reference("FETAL_GOD_TRADITION", "六十甲子胎神占方通行表", "近现代通书传承", "版本化六十日表",
                        "日用胎神占方", "https://tcmb.culture.tw/zh-tw/detail?id=11000025290&indexCode=MOCCOLLECTIONS",
                        "C_TRADITIONAL_TRANSMISSION", "六十甲子逐日胎神位置",
                        "已核对的《玉匣记》转录不含本项目整张六十日方位表，故不把它伪称为该书原文或古籍唯一结论。"));
    }
